...
subtitle: "Lecture 9: Forecasting Inter-related Series"
...
.right-column[
Economic variables are often (and usually) inter-related. 

- when incomes increase, people consume more. 
- when interest rates increase, people invest less.

We can model such relationships by regressing one variable on one or more other variables. 
]
