...
# Combining equally accurate uncorrelated forecasts

.right-column[
*Assumption*: $\sigma_i = \sigma_j = \sigma$ and $\rho=0$.

Suppose the individual forecasts are equally accurate and the forecast errors are uncorrelated, then the sample estimator of $w^*$ reduces to $0.5$, resulting in the equal-weighted forecast combination: $$\hat{y}_{c,t+h|t} = 0.5\hat{y}_{i,t+h|t} + 0.5\hat{y}_{j,t+h|t}$$
