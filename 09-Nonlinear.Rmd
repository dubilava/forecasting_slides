...
The AIC of this SETAR(2) model is `r round(aic,3)`, which is less than the AIC of the AR(2) model. But the SIC is `r round(sic,3)` which is greater than the SIC of the AR(2) model.
]
