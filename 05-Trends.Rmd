...
From this, we can obtain lower and upper intervals of the forecast, given by: $$y_{t+h|t}\pm 1.96\sigma_{t+h|t}\sqrt{h}$$
...
Indeed, if we regress $y$ on $x$ and $t$, where $t=1,\ldots,T$, the previously detected statistically significant (but spurious) relationship between the two series will vanish.
]
