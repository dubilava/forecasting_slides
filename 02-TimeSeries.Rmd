...
The simplest kind of time series is comprised of realizations from an independent and identically distributed random variable with zero mean and constant variance: $e_t \sim iid\left(0,\sigma^2\right)$. 
...
It is more of a norm, rather than an exception, for a time series to be correlated. This is especially true for economic time series.
